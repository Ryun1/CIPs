  ...
  - [Process](#process)
    - [1. Early stages](#1-early-stages)
      - [1.a. Authors open a pull request](#1a-authors-open-a-pull-request)
        ...
        - [Link to proposal from PR first comment](#link-to-proposal-from-pr-first-comment)
...
- [Rationale: how does this CIP achieve its goals?](#rationale-how-does-this-cip-achieve-its-goals)
  - [Key changes from CIP-0001 (version 1)](#key-changes-from-cip-0001-version-1)
    - [Introduction of Cardano Problem Statements](#introduction-of-cardano-problem-statements)
    - [Explicit enlisting](#explicit-enlisting)
    - [Nomination of new editors](#nomination-of-new-editors)
    - [Removal of `type` in the preamble](#removal-of-type-in-the-preamble)
    - [Simplification of the statuses](#simplification-of-the-statuses)
  - [Choice of CoC](#choice-of-coc)
- [Path to Active](#path-to-active-1)
